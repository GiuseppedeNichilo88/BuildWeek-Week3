...
*/
const aggiungiSkill = () => { me.skills.push('React'); return me.skills };
console.log(aggiungiSkill());

/* ESERCIZIO G
  Crea un pezzo di codice per rimuovere programmaticamente l'ultimo elemento dall'array "skills" contenuto nell'oggetto "me".
*/
const togliSkill = () => { me.skills.pop(); return me.skills };
console.log(togliSkill());
...
*/
const deleteOne = (str, ball) => {
    return ball ? str.substring(1) : str.substring(0, str.length - 1);
}
console.log(deleteOne(wizz, true));
console.log(deleteOne(wizz, false));
...
console.log(isThisAnEmail('xxx@isThisAnEmail.com'));
console.log(isThisAnEmail('xxx.isThisAnEmail,com'));
...
const searchAndDivide = (string) => {
    ...
    movies.forEach(el => (el.Title.includes(string)) ? obj.match.push(el) : obj.unmatch(el));
    return obj;
};
...
*/const allTxt = () => allTd.forEach(el => console.log(el.textContent));

/* ESERCIZIO 23
  Scrivi una funzione per aggiungere un background di colore rosso a ogni link all'interno della pagina.
*/
const paintItRed = function () {
    let allList = document.querySelectorAll('a').forEach(el => el.style.backgroundColor = 'red');
}
paintItRed();
/* ESERCIZIO 24
...
*/
const removeList = function (content) {
